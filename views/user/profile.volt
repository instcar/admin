...
{% block page_content %}
    <div class="clearfix">
        ...
        <div class="pull-right">
            <span class="green middle bolder">切换样式: &nbsp;</span>
    ...
    <div class="col-xs-12 col-sm-3 center">
	  ...
	  <span class="profile-picture">
	    <img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="{{ user['headpic'] }}_i.jpg"/>
	  </span>
            ...
            <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                <div class="inline position-relative">
                    ...
                    <ul class="align-left dropdown-menu dropdown-caret dropdown-lighter">
                        <li class="dropdown-header"> 选择状态</li>
    ...
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                ...
                <span class="editable" id="city">北京</span>
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <span class="editable" id="age">{% if user['age'] == 0 %}未知{% else %}{{ user['age'] }}{% endif %}</span>
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <span class="editable" id="signup">{{ user['addtime'] }}</span>
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <span class="editable" id="login">3 小时前</span>
            </div>
        </div>
        ...
        <div class="profile-info-row">
            ...
            <div class="profile-info-value">
                <span class="editable" id="about">{{ user['detail']['signature'] }}</span>
            </div>
        </div>
    </div>
    ...
    <div id="home" class="tab-pane in active">
        <div class="row">
            <div class="col-xs-12 col-sm-3 center">
		<span class="profile-picture">
		  <img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="{{ user['headpic'] }}_i.jpg"/>
		</span>
		    ...
		    online
                ...
                <div class="profile-user-info">
                    ...
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <span>{% if user['age'] == 0 %}未知{% else %}{{ user['age'] }}{% endif %}</span>
                        </div>
                    </div>
                ...
                <div class="profile-user-info">
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <a href="http://guweigang.com" target="_blank">http://guweigang.com</a>
                        </div>
                    </div>
                </div>
